...
async function main(){
    ...
    .prompt([
        ...
        {
            type: "input",
            message: "Please enter git hub user names of contributors:",
...
\nGitHub: ${gitUrl}
`)
var writeResult = fs.writeFileSync(path.join(__dirname, '../Good-README-Generator', 'readMeFinal.md'), result )
